...
export default function Chef() {
  return (
      ...
      <div className="mainContent">
        ...
        <h1 className="pageTitleText">シェフ</h1>
        </div>

        <ChefProfile
          name="西尾シェフ"
          images={[nishioMain, nishioSub]}
          intro="機内食調理機内食調理とホテルレストランにて32年の経歴を持ち、2008年にはシンガポールで行われた世界機内食コンクールで日本人として初の優勝。その後、日本航空（JAL）のコーポレートシェフとして、ファーストクラスや、世界各国の機内食をはじめ、政府専用機のメニュー開発に携わり、皇族への提供も担う。現在は(株)NKフーズコネクション代表取締役兼ICHISARAのオーナーシェフとして心を込めた一皿をお届けしております。"
        />
