...
<div className="mainContent">
        ...
        <section id="others" className="faqSection">
          ...
          <div className="faqItem">
            <h3>- 混雑時のお願い -</h3>
            <p>混雑時はお待ち時間が発生する場合がございます。ご予定がお決まりでしたら、事前のご予約がおすすめです。
              ご予約はInstagramのDMまたはお電話にて承っております。<strong>当日予約やお急ぎの方は、お電話でのご連絡をお願いいたします。</strong> (InstagramのDMは確認・返信にお時間をいただく場合がございます。) ご予約なしでのご来店も大歓迎です。            </p>
          </div>
